            ...
            <aside id="sidebar">
                ...
                <nav id="nav">
                    <ul class="menu collapsible shadow-bottom">
                        ...
                        <li><a href="<?php echo base_url(); ?>super_admin/post_news"><img src="img/icons/packs/fugue/16x16/application-form.png">Post News</a></li>
                        <li><a href="<?php echo base_url(); ?>super_admin/view_news"><img src="img/icons/packs/fugue/16x16/table.png">Manage News</a></li>
