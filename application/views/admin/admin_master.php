            ...
            <aside id="sidebar">
                ...
                <nav id="nav">
                    <ul class="menu collapsible shadow-bottom">
                        <li><a href="<?php echo base_url(); ?>super_admin" class="current"><img src="img/icons/packs/fugue/16x16/dashboard.png">Dashboard<span class="badge">2</span></a></li>
                        <li><a href="<?php echo base_url(); ?>super_admin/post_news"><img src="img/icons/packs/fugue/16x16/application-form.png">Post Notice</a></li>
                        <li><a href="<?php echo base_url(); ?>super_admin/view_news"><img src="img/icons/packs/fugue/16x16/table.png">Manage Notice</a></li>
                        <li><a href="<?php echo base_url(); ?>images_examples/add_image"><img src="img/icons/packs/fugue/16x16/ui-tab-content.png">Add Gallery Image</a></li>
                        <li><a href="<?php echo base_url(); ?>super_admin/view_user_message"><img src="img/icons/packs/fugue/16x16/application-form.png">View User Message</a></li>
                        <li><a href="<?php echo base_url(); ?>super_admin/add_moto"><img src="img/icons/packs/fugue/16x16/application-form.png">Add Moto</a></li>
                        <li><a href="<?php echo base_url(); ?>super_admin/view_moto"><img src="img/icons/packs/fugue/16x16/table.png">Manage Moto</a></li>
                        ...
                        <li><a href="#"><img src="img/icons/packs/fugue/16x16/door-open-in.png">Login</a></li>
                        <li>
